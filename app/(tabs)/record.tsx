...
function createTypeMeta(colors: ColorPalette): Record<RecordType, { label: string; unit: string | null; color: string }> {
  return {
    ...
    <View style={[styles.screen, { paddingTop: insets.top + spacing.lg }]}>
      ...
      <View style={styles.typeRow}>
        {QUICK_TYPES.map((t) => (
          ...
          >
            <Text style={[styles.typeChipText, selectedType === t && styles.typeChipTextActive]}>{typeMeta[t].label}</Text>
          </TouchableOpacity>
        ))}
      </View>
      ...
      <View style={styles.addRow}>
        ...
        <TouchableOpacity style={styles.saveBtn} onPress={save} disabled={saving}>
          {saving ? <ActivityIndicator color={colors.bg} size="small" /> : <Text style={styles.saveBtnText}>지금 기록</Text>}
        </TouchableOpacity>
      </View>
